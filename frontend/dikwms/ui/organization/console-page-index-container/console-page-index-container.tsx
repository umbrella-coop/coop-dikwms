...
export type OrganizationConsolePageIndexContainerProps = {
  /**
   * Index page title (e.g. "Organization console").
   */
  title?: ReactNode;
  /**
...
export function OrganizationConsolePageIndexContainer({
  title,
  description,
  extra,
  loading,
  children,
  'data-testid': testId = 'organization-console-page-index-container',
}: OrganizationConsolePageIndexContainerProps) {
  return (
    <section
